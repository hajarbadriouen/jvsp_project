...
const EditExamPage = () => {
  ...
  const generateLink = () => {
    const uniqueLink = `https://www.example.com/exams/${exam.title.replace(/\s+/g, '-').toLowerCase()}`;
    setExam({ ...exam, examLink: uniqueLink });
  };

  const handleAddQuestion = () => {
    // Add question to exam questions
    const newExam = { ...exam };
    const question = {
